...
public class SitemPakar extends JFrame {
        ...
        diagnosaButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                        ...
                        ||yaRadioButton16.isSelected()==true||tidakRadioButton16.isSelected()==true||yaRadioButton17.isSelected()==true||tidakRadioButton17.isSelected()==true||yaRadioButton18.isSelected()==true||tidakRadioButton18.isSelected()==true||yaRadioButton19.isSelected()==true||tidakRadioButton19.isSelected()==true)
                {
                    ...
                    if (yaRadioButton2.isSelected()==true&&yaRadioButton7.isSelected()==true&&yaRadioButton13.isSelected()==true&&yaRadioButton16.isSelected()==true){
                    ...
                    if (yaRadioButton3.isSelected()==true&&yaRadioButton2.isSelected()==true&&yaRadioButton8.isSelected()==true&&yaRadioButton10.isSelected()==true&&yaRadioButton15.isSelected()==true&&yaRadioButton11.isSelected()==true){
                    ...
                    if (yaRadioButton4.isSelected()==true&&yaRadioButton1.isSelected()==true&&yaRadioButton12.isSelected()==true&&yaRadioButton13.isSelected()==true&&yaRadioButton14.isSelected()==true&&yaRadioButton15.isSelected()==true){
                    ...
                    if (yaRadioButton4.isSelected()==true&&yaRadioButton2.isSelected()==true&&yaRadioButton13.isSelected()==true&&yaRadioButton8.isSelected()==true&&yaRadioButton16.isSelected()==true){
                        gejalaTextArea.setText("Bercak Merah Pada Ikan"+"\nInsang dan sirip menjadi rontok"+"\nKehilangan Nafsu Makan"+"\nKulit ikan melepuh"+"\nWarna tubuh kusam/gelap"+"\nNafas megap-megap dan sering ke permukaan air");
                    ...
                    if (yaRadioButton4.isSelected()==true&&yaRadioButton16.isSelected()==true&&yaRadioButton17.isSelected()==true&&yaRadioButton18.isSelected()==true&&yaRadioButton19.isSelected()==true){
                    ...
                    if (yaRadioButton4.isSelected()==true&&yaRadioButton2.isSelected()==true&&yaRadioButton3.isSelected()==true){
                    ...
                    if (yaRadioButton4.isSelected()==true&&yaRadioButton2.isSelected()==true&&yaRadioButton11.isSelected()==true&&yaRadioButton12.isSelected()==true&&yaRadioButton14.isSelected()==true){
                        gejalaTextArea.setText("Kehilangan Nafsu Makan"+"\nInsang dan sirip menjadi rontok"+"\nTerjadi dropsy (kembung) yang ditandai perut membengkan dan lembek berisi cairan merah kekuningan"+"\nIkan menjadi lemah dan pergerakannya lambat"+"\nWarna insang pucat");
                    ...
                    if (yaRadioButton2.isSelected()==true&&yaRadioButton6.isSelected()==true&&yaRadioButton3.isSelected()==true){
                        gejalaTextArea.setText("Kehilangan Nafsu Makan"+"\nLuka terutama di kepala, sirip, kulit badan bagian belakang, ekor dan insang"+"\nKulit ikan melepuh");
                    ...
                    if (yaRadioButton10.isSelected()==true){
                    ...
                    if (yaRadioButton5.isSelected()==true&&yaRadioButton9.isSelected()==true){
                    ...
                    if (yaRadioButton13.isSelected()==true&&yaRadioButton18.isSelected()==true&&yaRadioButton19.isSelected()==true){
    ...
    public static void main(String[] args) {
        JFrame mainFrame = new com.danang.sistempakarbaru.SitemPakar();
